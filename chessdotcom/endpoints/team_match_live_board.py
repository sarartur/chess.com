...
) -> "GetTeamMatchLiveBoardResponse":
    """
    :param match_id: the id of the match.
    :param board_num: the number of the board.
    :param tts: the time the client will wait before making the first request.
    :returns: :obj:`GetTeamMatchLiveBoardResponse` object containing details
...
class ResponseBuilder(BaseResponseBuilder):
    def build(self, text):
        ...
        return GetTeamMatchLiveBoardResponse(
...
class GetTeamMatchLiveBoardResponse(ChessDotComResponse):
    """
