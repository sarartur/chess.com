...
def player_profile(username: str) -> Dict:
    ...
    r = _internal.do_request(f"/player/{username}")
...
def titled_players(title_abbrev: str) -> Dict:
    ...
    r = _internal.do_request(f"/titled/{title_abbrev}")
    return json.loads(r.data.decode('utf-8'))
...
def player_stats(username: str) -> Dict:
    ...
    r = _internal.do_request(f"/player/{username}/stats")
    return json.loads(r.data.decode('utf-8'))
...
def player_is_online(username: str) -> Dict:
    ...
    r = _internal.do_request(f"/player/{username}/is-online")
    return json.loads(r.data.decode('utf-8'))
...
def player_current_games(username: str) -> Dict:
    ...
    r = _internal.do_request(f"/player/{username}/games")
    return json.loads(r.data.decode('utf-8'))
...
def player_current_games_to_move(username: str) -> Dict:
    ...
    r = _internal.do_request(f"/player/{username}/games/to-move")
    return json.loads(r.data.decode('utf-8'))
...
def player_games_archives(username: str) -> Dict:
    ...
    Parameters:
        username -- username of the player
    """
    r = _internal.do_request(f"/player/{username}/games/archives")
    return json.loads(r.data.decode('utf-8'))
...
def player_games_by_month(username: str, yyyy: str, mm: str) -> Dict:
    ...
    """
    r = _internal.do_request(f"/player/{username}/games/{yyyy}/{mm}")
    return json.loads(r.data.decode('utf-8'))
...
def player_games_by_month_pgn(username: str, yyyy: str, mm: str):
    ...
    r = _internal.do_request(f"/player/{username}/games/{yyyy}/{mm}/pgn")
    return r.data
...
def player_clubs(username: str) -> Dict:
    ...
    Parameters:
        username -- username of the player
    """
    r = _internal.do_request(f"/player/{username}/clubs")
    return json.loads(r.data.decode('utf-8'))
...
def player_team_matches(username: str) -> Dict:
    ...
    Parameters:
        username -- username of the player
    """
    r = _internal.do_request(f"/player/{username}/matches")
    return json.loads(r.data.decode('utf-8'))
...
def player_tournaments(username: str) -> Dict:
    ...
    r = _internal.do_request(f"/player/{username}/tournaments")
    return json.loads(r.data.decode('utf-8'))
...
def clubs(url_id: str) -> Dict:
    ...
    """
    r = _internal.do_request(f"/club/{url_id}")
    return json.loads(r.data.decode('utf-8'))
...
def club_members(url_id: str) -> Dict:
    ...
    Parameters:
        url_id -- URL for the club's web page on www.chess.com.
    """
    r = _internal.do_request(f"/club/{url_id}/members")
    return json.loads(r.data.decode('utf-8'))
...
def club_matches(url_id: str) -> Dict:
    ...
    Parameters:
        url_id -- URL for the club's web page on www.chess.com.
    """
    r = _internal.do_request(f"/club/{url_id}/matches")
    return json.loads(r.data.decode('utf-8'))
...
def tournament(url_id: str) -> Dict:
    ...
    Parameters:
        url_id -- URL for the club's web page on www.chess.com.
    """
    r = _internal.do_request(f"/tournament/{url_id}")
    return json.loads(r.data.decode('utf-8'))
...
def tournament_round(url_id: str, round_num: int) -> Dict:
    ...
    """
    r = _internal.do_request(f"/tournament/{url_id}/{round_num}")
    return json.loads(r.data.decode('utf-8'))
...
def tournament_round_group(url_id: str, round_num: int, group_num: int) -> Dict:
    ...
    """
    r = _internal.do_request(f"/tournament/{url_id}/{round_num}/{group_num}")
    return json.loads(r.data.decode('utf-8'))
...
def team_match(match_id: int) -> Dict:
    ...
    """
    r = _internal.do_request(f"/match/{match_id}")
    return json.loads(r.data.decode('utf-8'))
...
def team_match_board(match_id: int, board_num: int) -> Dict:
    ...
    """
    r = _internal.do_request(f"/match/{match_id}/{board_num}")
    return json.loads(r.data.decode('utf-8'))
...
def team_match_live(match_id: int) -> Dict:
    ...
    Parameters:
        match_id -- the id of the match
    """
    r = _internal.do_request(f"/match/live/{match_id}")
    return json.loads(r.data.decode('utf-8'))
...
def team_match_live_board(match_id: int, board_num: int) -> Dict:
    ...
    Parameters:
        ...
        board_num -- the number of the board
    """
    r = _internal.do_request(f"/match/live/{match_id}/{board_num}")
    return json.loads(r.data.decode('utf-8'))
...
def country(iso: str) -> Dict:
    ...
    """
    r = _internal.do_request(f"/country/{iso}")
    return json.loads(r.data.decode('utf-8'))
...
def country_players(iso):
    ...
    Parameters:
        iso -- country's 2-character ISO 3166 code
    """
    r = _internal.do_request(f"/country/{iso}/players")
    return json.loads(r.data.decode('utf-8'))
...
def country_clubs(iso: str) -> Dict:
    ...
    Parameters:
        iso -- country's 2-character ISO 3166 code
    """
    r = _internal.do_request(f"/country/{iso}/clubs")
    return json.loads(r.data.decode('utf-8'))
